...
class anaEkran(QMainWindow):
  def __init__(self,xx="Başlıksız"):
    ...
    self.dugme3 = QPushButton('Kişi Ara')
    icerik.addWidget(self.dugme3)
    self.dugme4 = QPushButton('Kişi Sil')
    icerik.addWidget(self.dugme4)
    self.dugme5 = QPushButton('Kişi Düzelt')
  ...
  def ekle(self):
    self.close()
    self.ekleme = ekleme('Kayıt Ekleme')
    self.ekleme.show()

  def listele(self):
    self.close()
    self.listeleme = listelemeekranı('Kayıt Ekleme')
    self.listeleme.show()
...
class listelemeekranı(QMainWindow):
  def __init__(self,xx="Başlıksız"):
    super().__init__()
    self.setWindowTitle(xx)
...
class AramaEkrani(QMainWindow):
  ...
  def __init__(self,xx="Başlıksız"):
    ...
    baslatB = QPushButton('baslat')
    self.icerik.addWidget(baslatB,1,0)
    self.bulunanlar = []
    baslatB.clicked.connect(self.baslat)
    ...
    self.d1 = QPushButton('Ana ekrana dön')
    self.icerik.addWidget(self.d1,3,0)
    self.d1.clicked.connect(self.anaEkranaDon)
...
class DuzeltmeEkrani(QMainWindow):
  ...
  def __init__(self,xx="Başlıksız"):
    ...
    self.d1 = QPushButton('Ana ekrana dön')
    self.icerik.addWidget(self.d1,7,0)
    self.d1.clicked.connect(self.anaEkranaDon)
